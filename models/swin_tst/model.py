...
class PredictionHead(nn.Module):
    def __init__(
        ...
        self.linear = nn.Linear(d_model * num_patch, forecast_len)
...
class SwinTransformer(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.head = nn.Linear(
            self.num_features * (patches_resolution // (4 ** (self.num_layers - 1))),
            pred_len,
        )

        self.revin_layer = RevIN(in_chans, affine=True, subtract_last=False)
