...
class CrossPatchTST(nn.Module):
    ...
    def __init__(
        ...
        self.backbone = CrossPatchTSTEncoder(
            c_in=c_in,
            num_patch=num_patch,
            patch_len=patch_len,
...
class CrossPatchTSTEncoder(nn.Module):
    def __init__(
        self,
        c_in,
        num_patch,
        ...
        dropout,
        factor,
        shared_embedding=True,  # TODO True for training
        norm="BatchNorm",
        pre_norm=False,
        activation="gelu",
        pe="zeros",
        ...
        self.W_pos = nn.Parameter(
            ...
            .reshape(c_in, num_patch, d_model)
            .float(),
