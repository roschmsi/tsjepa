...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.enc_embedding = DataEmbedding_OnlyToken(configs.enc_in, configs.d_model, configs.embed, configs.freq,
                                                  configs.dropout)
        self.dec_embedding = DataEmbedding_OnlyToken(configs.dec_in, configs.d_model, configs.embed, configs.freq,
                                                  configs.dropout)
